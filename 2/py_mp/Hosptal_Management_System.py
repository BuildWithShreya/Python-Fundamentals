...
def display_all_records(patients, appointments, prescriptions, bills, medical_records):
    ...
    print('\nAll Prescriptions:')
    for patient_id, prescription_list in prescriptions.items():
        print(f'Patient ID: {patient_id}')
        for idx, prescription in enumerate(prescription_list, start=1):
            print(f'{idx}. {prescription}')
        print()
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            display_all_records(patients, appointments, prescriptions, bills, medical_records)
        elif choice == '9':
            print('Exiting...')
            break
        else:
